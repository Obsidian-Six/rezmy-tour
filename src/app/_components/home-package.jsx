      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 md:my-4 max-md:my-2">
            {
                ...
                <div className="">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <Link href={'/packages'} className="bg-primary-main text-white md:py-2 py-1 md:px-4 md:rounded-lg rounded-sm w-full md:text-base sm:text-sm text-xs text-center">
                      Book Now
                      </Link>
