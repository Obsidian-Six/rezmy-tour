    ...
    <div className="max-w-6xl mx-auto md:space-y-16 max-md:space-y-4 md:my-10 max-md:my-8">
      ...
      {pack.map((ele, i) => (
        ...
        >
          ...
          <div className="bg-white md:w-[60%] md:px-6 lg:flex-shrink-1 max-md:px-2 md:py-4">
            ...
            <div className="md:mt-4 max-md:mt-2">
              ...
              <div className="lg:mt-2 max-md:mt-2 grid md:grid-cols-2 grid-cols-1 w-full md:gap-4 gap-2">
                <button
                  onClick={handleOpen}
